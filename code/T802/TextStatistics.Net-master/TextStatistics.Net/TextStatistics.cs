...
namespace TextStatistics.Net
{
    public class TextStatistics
    {
        ...
        {
            //double score1 = 0.4 * ((AverageWordsPerSentence + 100) * PercentageWordsWithThreeSyllables);
            //return Math.Round(score1, 1);
        ...
        public int WordsWithThreeSyllables
        {
            get
            {
                ...
                {
                    _wordsWithThreeSyllables = CountWordsWithThreeSyllables(false);
                }
